...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        //lee
        List<Deportista> datosFutbol= campeonato.leerArchivo("p3_ej2\\p3_ej2\\inscriptosFutbol.csv");
        List<Deportista> datosPinPon= campeonato.leerArchivo("p3_ej2\\p3_ej2\\inscriptosPinPon.csv");
